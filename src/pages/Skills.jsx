...
const Skills = () => {
  return (
    ...
    >
      ...
      >
        <BadgeCheck className="text-green-400 w-9 h-9" />
        ...
        {skillCards.map((card, i) => (
          ...
          >
            <GlassCard
              ...
              hover:shadow-[0_0_15px_rgba(0,255,255,0.1)] rounded-3xl"
            >
              <h3 className="text-2xl md:text-2xl text-white font-bold border-b border-white/10 pb-4 flex items-center gap-2">
                {card.icon}
                {card.title}
              </h3>
